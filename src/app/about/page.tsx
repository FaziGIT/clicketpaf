      ...
      <div className="w-full bg-main-dark-blue py-10">
          <div className="container mx-auto px-4">
              ...
              <p className="text-lg text-txt-soft-white text-center max-w-2xl mx-auto">
                  ...
                  unique, sécurisée et immersive. Que vous soyez un joueur débutant ou un expert des tables de blackjack
                  et
                  de poker, nous avons conçu notre plateforme pour répondre à toutes vos attentes.
              </p>

              <div className="flex justify-center my-6">
                  <Image src="/images/cardImage.webp" alt="CardImage" width={600} height={300}
